...
/**
 * converts dtp string to String of DPT Main Type
 * eg. 'DPT7.600' -> 'DPT7' / 'dpt1' -> 'DPT1'
 */
module.exports.dpt2MainDPT = function(dpType) {
  const dottedDPT = dpType + '.';
  const dptMainType = dottedDPT.slice(0, dottedDPT.indexOf('.', 4));
  return dptMainType.toUpperCase();
};
